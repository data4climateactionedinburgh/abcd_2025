...
By way of comparison, here are the warming stripes for Scotland, from the same online tool. This distinctive and memorable dataviz uses only the colour and shading of the bars to depict the temperature change, whereas the bar chart above also uses the vertical axis, making the scale of the temperature rise even clearer.

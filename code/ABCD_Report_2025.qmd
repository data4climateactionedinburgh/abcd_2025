...
![Manually added grid lines show current temperature difference](images/annotated%20EUROPE-United_Kingdom-Edinburgh-1850-2024-BK-barslabel.png){fig-alt="Yellow lines added to the bar chart for Edinburgh trace the point on the axis corresponding to temperature differences for 2022 and 2024"}
